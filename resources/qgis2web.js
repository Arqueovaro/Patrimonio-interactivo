...
map.getView().fit([-76415.963020, 4677486.061746, -34928.376712, 4699423.237247], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa arqueológico interactivo</h2>';
        return titleElement;
    })(),
